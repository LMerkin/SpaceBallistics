...
namespace SpaceBallistics
{
  ...
  // z0 <-> (-z0), alpha <-> (-alpha).
  // When z0=0 and alpha=0, we have the same case as "MoIS_TrConeXY"   with
  // alpha=0 (the truncated cone axis coinciding with OX). However, in this
  // case, the default args are not provided:
  //
  ...
  // When alpha=0 and z0=0, we have the same case as "MoIS_SpherSegm_XY" with
  // alpha=0, ie the axis of the Spherical Segment coincides with OX; however,
  // in this case, default args are not provided:
  //
